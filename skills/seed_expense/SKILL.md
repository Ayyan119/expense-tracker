...
```bash
# Usage: .venv/bin/python skills/seed_expense/scripts/seed_expense.py <user_id> <n_expenses> <n_last_months>

# Example: Add 10 random expenses for User ID 1 spread over the last 3 months
.venv/bin/python skills/seed_expense/scripts/seed_expense.py 1 10 3
```
